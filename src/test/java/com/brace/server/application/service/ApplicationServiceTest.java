...
class ApplicationServiceTest {
    ...
    void createApplicationSavesProgressApplicationAndNotification() {
        ...
        assertThat(application.getUser().getId()).isEqualTo(2L);
        ...
        assertThat(notifications.getFirst().getUser().getId()).isEqualTo(1L);
    ...
    void cancelApplicationRejectsNonProgressStatuses() {
        ProjectFixture fixture = saveProjectFixture(1L, 10L, 10L, 3, ProjectStatus.RECRUITING, LocalDate.now().plusDays(1));
        Application passed = saveApplication(fixture.applicant, fixture.project, fixture.role, "pass");
        passed.pass();
        ProjectFixture failedFixture = saveProjectFixture(2L, 20L, 20L, 3, ProjectStatus.RECRUITING, LocalDate.now().plusDays(1));
        Application failed = saveApplication(failedFixture.applicant, failedFixture.project, failedFixture.role, "fail");
        failed.fail();
        ProjectFixture canceledFixture = saveProjectFixture(3L, 30L, 30L, 3, ProjectStatus.RECRUITING, LocalDate.now().plusDays(1));
    ...
    void updateApplicationAutoFailsRemainingProgressApplicationsWhenRecruitmentCloses() {
        ...
        Application otherProjectApplication = saveApplication(saveUser(4L), saveOtherProject(10L, fixture.owner), fixture.role, "other project");
    ...
    private ProjectFixture saveProjectFixture(Integer recruitCount, ProjectStatus status, LocalDate deadline) {
        return saveProjectFixture(1L, 10L, 10L, recruitCount, status, deadline);
    }
